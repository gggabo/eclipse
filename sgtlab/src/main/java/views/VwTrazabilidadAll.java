...
public class VwTrazabilidadAll extends Panel {
	...
	private VwProyectosAll vwproyectos;
	...
	public VwTrazabilidadAll(VwProyectosAll vwproyectos, Proyecto proyecto) {
	...
	public Component buildUI() {
		...
		mainMenu.addItem("Ir a proyectos", VaadinIcons.ARROW_LEFT, new Command() {
			...
			public void menuSelected(MenuItem selectedItem) {
				vwproyectos.mainLayout.removeComponent(VwTrazabilidadAll.this);
	...
	public void buscarEnLab(int lab) {
		...
		dialogReactivoWindow.addComponentBody(new VwLaboratoriosBuscarAll(VwTrazabilidadAll.this, lab));
		dialogReactivoWindow.getOkButton().setVisible(false);
